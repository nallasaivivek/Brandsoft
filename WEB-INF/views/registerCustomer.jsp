...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead" align="center">Please fill in your information below:</p>
        </div>
<hr>
...
<hr>
        ...
        <br><br>
       <h1 align="center"><input type="submit" value="submit" class="btn btn-default" > 
       <a href="<c:url value="/" />" class="btn btn-default" >Cancel</a></h1> 
        </form:form>
